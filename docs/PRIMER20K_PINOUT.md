...
|---|---|---|---|---|
| **`i_spi_sclk`** | Pin C13 | Input | PULL_DOWN | Dual-SPI Clock Input (Up to 50 MHz) |
| **`i_spi_cs_n`** | Pin B13 | Input | PULL_UP | Active-Low Chip Select |
| **`io_spi_io0`** | Pin B14 | Inout | PULL_DOWN | Dual-SPI Data Line 0 (MOSI / SDIO0) |
| **`io_spi_io1`** | Pin A14 | Inout | PULL_DOWN | Dual-SPI Data Line 1 (MISO / SDIO1) |
